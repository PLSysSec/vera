...
andTest :: BenchTest
andTest = benchTestCase "and" $ error ""
...
rshTest :: BenchTest
rshTest = benchTestCase "rsh" $ error ""
  -- (c1, c2, c3) <- D.evalVerif Nothing $ do
...
lshTest :: BenchTest
lshTest = benchTestCase "lsh" $ error ""
  -- (c1, c2, c3) <- D.evalVerif Nothing $ do
...
urshTest :: BenchTest
urshTest = benchTestCase "ursh" $ error ""
  -- (c1, c2, c3) <- D.evalVerif Nothing $ do
