...
numberBitwiseOr left right = error "Not ported"
  -- zero <- D.i32c 0
  -- intmax <- D.i32max
...
numberBitwiseAnd left right = error "Not ported"
  -- zero <- D.i32c 0
...
numberBitwiseXor left right = error "Not ported"
  -- zero <- D.i32c 0
...
numberShiftLeft left right = error "Not ported"
  -- thirtyOne <- D.i32c 31
  -- zero <- D.i32c 0
  -- intmax <- D.i32max
  -- intmin <- D.i32min
...
numberShiftRight left right = error "Not ported"
  -- thirtyOne <- D.i32c 31
  -- zero <- D.i32c 0
...
numberShiftRightLogical left right = error "Not ported"
  -- thirtyOne <- D.i32c 31
  -- zero <- D.i32c 0
  -- intmax <- D.i32max
  -- uintmax <- D.ui32max
